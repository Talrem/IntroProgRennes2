function palyndrome(){
  ...
  for(var i = 0; i < mot.length ; i++){
    ...
    */
    if(mot[i] != mot[mot.length - 1 - i]) return alert("Le mot n'est pas un palyndrome");
    //Si jamais les lettres sont différentes, on va exécuter l'instruction return, ce qui va mettre fin au programme en affichant que ce n'est pas un palyndrome.
  }
  //Mais si jamais on sort de la boucle for, c'est que le programme n'a pas été stoppé, c'est donc un palyndrome.
  alert("Le mot est un palyndrome");
}
